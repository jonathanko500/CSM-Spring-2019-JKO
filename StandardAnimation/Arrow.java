 ...
 * The arrow head logic is relative to the lineArrowBody
...
public class Arrow {
    ...
    private Text groupArrowLinesText;
    ...
    public Arrow(EdgeAnimationDataContainer edgeAnimationDataContainer) {
        ...
        // Duration/Length of the edge
        groupArrowLinesText = new Text(String.format("%s", this.edgeAnimationDataContainer.getWrapperPseudo().getEdge().getEdgeName()));
