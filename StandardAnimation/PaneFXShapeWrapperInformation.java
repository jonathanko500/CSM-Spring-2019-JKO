 ...
 * Joseph Edradan
 * <p>
 * This file is the text and the text animation for the FXShapeWrapper
 */
...
public class PaneFXShapeWrapperInformation extends StackPane {
    ...
    private FXShapeWrapper fxShapeWrapper;
    ...
    public PaneFXShapeWrapperInformation(FXShapeWrapper fxShapeWrapper) {
        this.fxShapeWrapper = fxShapeWrapper;

        height = this.fxShapeWrapper.getCircle().getRadius();

        textVertex.setText(fxShapeWrapper.wrapperActualNormal.getVertex().getEventName());
        this.getChildren().add(textVertex);
...
//        updateTextPositions();
    ...
    public void updateTextPositions() {
        ...
        gridPaneForward.setTranslateX(fxShapeWrapper.getCircle().getCenterX() + gridPaneForward.getWidth() / 2 - shiftLeft);
...
//        gridPaneForward.setTranslateY(-height + 17); // Use this if you are not displaying count/degree
        ...
        gridPaneBackward.setTranslateX(fxShapeWrapper.getCircle().getCenterX() + gridPaneBackward.getWidth() / 2 - shiftLeft);
