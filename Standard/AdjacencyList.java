...
//*******************************************************************************************************************
    ...
    public void addToArrayListWrapperActual(int vertexIndexStart, int vertexIndexEnd, int edgeDuration) {
        ...
        // Create Edge
        Edge edgeTemp = new Edge(edgeCounter, edgeDuration);
    ...
    private void addToArrayListWrapperActual(int vertexIndexStart, int vertexIndexEnd, Edge edge) {
...
//    }
    ...
    private void createAdjacencyListInverse() {
        ...
        // addToArrayListWrapperActual using arrayListWrapperActual.getVertex().getIndex() as the source and wrapperActualParent.getVertex().getIndex()
        ...
        for (int i = 0; i < arrayListWrapperActual.size(); i++) {
            ...
            for (int j = 0; j < wrapperActualParent.getArrayListWrapperPseudo().size(); j++) {
                ...
                adjacencyListInverse.addToArrayListWrapperActual(
    ...
    private void createAdjacencyListSolution() {
        ...
        for (int i = 0; i < arrayListWrapperActual.size(); i++) {
            ...
            for (int j = 0; j < wrapperActualParent.getArrayListWrapperPseudo().size(); j++) {
                ...
                // If Both wrapperActualParent and getWrapperActual(wrapperPseudo.getVertex().getIndex()) are Marked then call addToArrayListWrapperActual
                ...
                if (wrapperActualParent.isMarked() && getWrapperActual(wrapperPseudo.getVertex().getIndex()).isMarked()) {
                    adjacencyListSolution.addToArrayListWrapperActual(
                            wrapperActualParent.getVertex().getIndex(),
    ...
    private boolean isGraphCyclic() {
        ...
        pathFinder.setArrayListWrapperActualGiven(arrayListWrapperActual);
